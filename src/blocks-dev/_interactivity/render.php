...
<div class="bg-amber-100 border-2 border-amber-300 p-4 my-3 rounded shadow-md" data-wp-interactive="makerblocks/interactivity" <?php echo wp_interactivity_data_wp_context($ourContext) ?>>
	<p>
