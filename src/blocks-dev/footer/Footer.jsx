...
export default function Footer({
    ...
    const ctaSection = {
        enabled: cta.enabled !== false, // Default to true unless explicitly disabled
    ...
    return (
        <>
            <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
                {/* CTA Section - only render if enabled */}
                {ctaSection.enabled && (
                ...
                {/* Footer Navigation */}
                <div className={`${ctaSection.enabled ? 'mt-24' : ''} border-t border-gray-900/10 pt-12 xl:grid xl:grid-cols-3 xl:gap-8`}>
                    <img
                        alt={siteName}
                        src={logoUrl}
                        className="h-9"
