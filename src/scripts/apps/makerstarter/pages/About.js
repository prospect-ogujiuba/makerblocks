  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <BuildingOffice2Icon className="mx-auto h-12 w-12 text-green-600" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-4 text-lg text-gray-500">
                Your company's story and history goes here. Share your journey, challenges,
                and how you've grown over the years.
              </p>
            </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <HeartIcon className="mx-auto h-12 w-12 text-green-600" />
            <h2 className="mt-4 text-3xl font-bold text-gray-900">Our Values</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((value) => (
              <div key={value} className="bg-white p-6 rounded-lg shadow-sm">
                <RocketLaunchIcon className="h-8 w-8 text-green-600" />
                <h3 className="mt-4 text-xl font-semibold text-gray-900">Value {value}</h3>
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <UserGroupIcon className="mx-auto h-12 w-12 text-green-600" />
            <h2 className="mt-4 text-3xl font-bold text-gray-900">Our Team</h2>
          </div>
          <TabGroup>
            <TabList className="flex space-x-1 rounded-xl bg-green-50 p-1 mb-8">
