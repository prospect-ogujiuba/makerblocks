...
const PortfolioPage = () => {
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<div className="bg-green-50 py-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<FolderIcon className="mx-auto h-12 w-12 text-green-600" />
			...
			<div className="py-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="relative overflow-hidden rounded-xl bg-green-600">
						...
						<div className="relative px-8 py-16 sm:px-12 sm:py-24">
							<div className="max-w-2xl">
								...
								<button className="mt-8 inline-flex items-center rounded-md border border-transparent bg-white px-6 py-3 text-base font-medium text-green-600 shadow-sm hover:bg-green-50">
									View Project
							...
							{categories.map((category) => (
								<Tab
									...
									className={({ selected }) =>
										...
										} w-full rounded-lg py-2.5 text-sm font-medium leading-5 ring-white ring-opacity-60 ring-offset-2 ring-offset-green-400 focus:outline-none focus:ring-2`
									}
								>
									{category}
								</Tab>
