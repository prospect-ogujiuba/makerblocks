							...
							>
								...
								<div className="p-6">
									...
									<div className="mt-6 pt-6 border-t border-gray-200">
										...
										<button className="mt-4 w-full inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
											View Case Study
