      ...
      <div className="bg-green-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <EnvelopeIcon className="mx-auto h-12 w-12 text-green-600" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="mt-2 text-gray-500 text-center">Mon-Fri from 8am to 5pm</p>
              <p className="mt-2 text-green-600">(555) 123-4567</p>
            </div>

            <div className="flex flex-col items-center p-6 bg-gray-50 rounded-lg">
              <MapPinIcon className="h-8 w-8 text-green-600" />
              <h3 className="mt-4 text-lg font-medium text-gray-900">Visit Us</h3>
              <p className="mt-2 text-gray-500 text-center">123 Business Street</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <form onSubmit={handleSubmit}>
                <div className="space-y-6">
                      ...
                      <div className="mt-2 grid grid-cols-3 gap-3">
                        {inquiryTypes.map((type) => (
                          <Radio
                            ...
                            className={({ checked }) =>
                              `${
                                checked ? 'bg-green-600 text-white' : 'bg-white text-gray-900'
                              } cursor-pointer rounded-md px-3 py-2 text-sm font-medium border
                              hover:bg-green-300 flex items-center justify-center`
                            }
                          >
                            {type.name}
                          </Radio>
                  ...
                  <button
                    type="submit"
                    className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                  >
                    Send Message
            ...
            <div>
              ...
              <div className="md:grid grid-cols-2 items-center gap-4">
                {[1, 2].map((office) => (
                  <div key={office} className="bg-white rounded-lg shadow-sm p-6">
