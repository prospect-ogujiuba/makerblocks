...
import { Disclosure, DisclosurePanel, DisclosureButton, Popover, PopoverPanel, PopoverButton } from "@headlessui/react";
import {
	ShoppingBagIcon,
	FunnelIcon,
	ChevronDownIcon,
			...
			<div className="bg-green-50 py-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						<ShoppingBagIcon className="mx-auto h-12 w-12 text-green-600" />
								...
								>
									...
									<div className="p-4">
										...
										<div className="mt-4 flex items-center justify-between">
											...
											<button className="px-4 py-2 text-sm font-medium text-green-600 hover:text-green-500">
												Add to Cart
											</button>
										</div>
									</div>
